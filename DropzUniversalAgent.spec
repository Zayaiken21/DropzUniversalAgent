...
datas = [('streamlit_app.py', '.'), ('frontend', 'frontend'), ('components', 'components'), ('chat_backend', 'chat_backend'), ('backend', 'backend'), ('agents', 'agents'), ('strategies', 'strategies'), ('styles', 'styles'), ('tools', 'tools'), ('assets', 'assets'), ('.streamlit', '.streamlit'), ('data', 'data'), ('frontend\\dropz.db', 'frontend'), ('build_info.json', '.')]
binaries = []
hiddenimports = ['chat_agent', 'chat_backend', 'chat_backend.chat_db', 'components', 'components.charts', 'components.dashboard_mt5_data', 'backend']
